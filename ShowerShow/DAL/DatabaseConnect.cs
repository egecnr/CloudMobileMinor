...
namespace ShowerShow.DAL
{
    internal class DatabaseConnect
    {
        ...
        public static async Task StartDb(string[] args) //make back into main if needed
        {
            try
            {
        ...
        private async Task CreateContainerAsync()
        {
            ...
            this.container = await this.database.CreateContainerIfNotExistsAsync(containerId, "/UserId", 400);
